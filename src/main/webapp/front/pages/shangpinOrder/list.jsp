                ...
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <tr v-for="(item,index) in dataList" v-bind:key="index">
                            <td style="width: 60px;">{{item.addressName}}</td>
                            <td style="width: 60px;">{{item.addressPhone}}</td>
                            <td style="width: 60px;">{{item.addressDizhi}}</td>
                            ...
                            <td style="width: 150px;">{{item.shangpinOrderCourierName}}</td>
                            <td style="width: 150px;">{{item.shangpinOrderCourierNumber}}</td>
                            ...
                            <td style="width: 100px;">
                                <button v-if="item.shangpinOrderTypes==1" @click="refund(item.id)" type="button" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-warm">
                                ...
                                <button v-if="item.shangpinOrderTypes==3" @click="receiving(item.id)" type="button" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-warm">
                                ...
                                <button v-if="item.shangpinOrderTypes==4" @click="commentback(item.id)" type="button" class="layui-btn layui-btn-sm layui-btn-radius btn-theme">
