        ...
        <div class="data-detail">
            <div class="data-detail-breadcrumb">
                <span class="layui-breadcrumb">
                    ...
                    <a><cite>{{detail.shangjiaName}}</cite></a>
                </span>
            ...
            <div class="layui-row">
                ...
                <div class="layui-col-md7" style="padding-left: 20px;">
                        <h1 class="title">{{detail.shangjiaName}}</h1>

                        <div v-if="detail.shangjiaPhone" class="detail-item">
                            <span>联系方式：</span>
                            <span class="desc">
                                        {{detail.shangjiaPhone}}
                            </span>
                        </div>

                        <div v-if="detail.shangjiaEmail" class="detail-item">
                            <span>邮箱：</span>
                            <span class="desc">
                                        {{detail.shangjiaEmail}}
                            </span>
                        </div>

                        <div v-if="detail.shangjiaXingjiTypes" class="detail-item">
                            <span>商家信用类型：</span>
                            <span class="desc">
                                {{detail.shangjiaXingjiValue}}
                            </span>
                        </div>

                    <div class="detail-item">

                        <!--<button onclick="addShangjiaqqqqqqqq()" type="button" class="layui-btn layui-btn-warm">
                                添加到购物车
                            </button>-->
            ...
            <div class="layui-row">
                <div class="layui-tab layui-tab-card">
                    ...
                    <ul class="layui-tab-title">
                            <li class="layui-this">商家简介</li>
                    </ul>

                    <div class="layui-tab-content">
                            <div class="layui-tab-item layui-show">
                                <div v-html="myFilters(detail.shangjiaContent)"></div>
                            </div>
    ...
    var vue = new Vue({
        ...
        methods: {
            ...
            ,shangjiaYuyue(){
                ...
                // _this.jump("../shangjiaOrder/add.jsp");
                ...
                layui.http.requestJson('shangjiaOrder/add', 'post', data, function (res) {
                    if(res.code == 0) {
                        layui.layer.msg('预约成功', {
                            ...
                            _this.jump("../shangjiaOrder/list.jsp");
                        });
                    }else{
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage', 'rate'], function () {
        ...
        http.request(`shangjia/list`, 'get', {
            ...
            shangjiaDelete: 1,
                ...
                shangjiaXingjiTypes: vue.detail.shangjiaXingjiTypes,
