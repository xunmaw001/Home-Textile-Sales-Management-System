                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="shangjiaId" name="shangjiaId" v-model="ruleForm.shangjiaId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shangpinUuidNumber" name="shangpinUuidNumber" class="form-control"
                                               v-model="ruleForm.shangpinUuidNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>是否明星产品</label>
                                    <input style="width: 450px" id="mingxingchanpinValue" name="mingxingchanpinValue" class="form-control"
                                           v-model="ruleForm.mingxingchanpinValue" readonly>
                                </div>
