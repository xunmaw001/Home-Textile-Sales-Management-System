    ...
    <div class="ng-container ng-fault">
        <div class="ng-inmod ng-fault ng-paddor ng-bg-fff">
            <div class="ng-inmod-ini">
                    <div class="newtit">
                        <h2>商品展示</h2>
                        <span class="index_intro">DATA SHOW</span>
                    </div>
                    <br />                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="shangpinUuidNumber" id="shangpinUuidNumber" placeholder="商品编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">是否明星产品</label>
                          <div class="layui-input-inline">
                              <select name="mingxingchanpinTypes" id="mingxingchanpinTypes" lay-filter="mingxingchanpinTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in mingxingchanpinTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-md-3" v-for="(item,index) in dataList" >
                                <div class="galry-grid grid-top-rgt">
                                    <a href="javascript:return false;"  @click="jumpCheck('../shangpin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img class="img-responsive zoom-img" :src="item.shangpinPhoto?item.shangpinPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="w3agile-text">
                                            <h5>
                                                <span>{{item.shangpinName}}</span>
                                                <br/>
                                                <span v-if="item.shangpinNewMoney">
...
<script>
    ...
    // 当前表的字典表
        ...
        function mingxingchanpinTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=mingxingchanpin_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.mingxingchanpinTypesList = res.data.list;
                }
            });
        }
        // 是否上架的查询
        ...
        function pageList() {
            ...
            if (jquery('#shangpinUuidNumber').val() != null && jquery('#shangpinUuidNumber').val() != "" && jquery('#shangpinUuidNumber').val() != "null" ) {
                param['shangpinUuidNumber'] = jquery('#shangpinUuidNumber').val();
            }
            ...
            var mingxingchanpinTypes = $("#mingxingchanpinTypes").find("option:selected").val();
            if (mingxingchanpinTypes != null && mingxingchanpinTypes != "" && mingxingchanpinTypes != "null") {
                param['mingxingchanpinTypes'] = mingxingchanpinTypes;
            }
