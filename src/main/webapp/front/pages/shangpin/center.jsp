				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shangpinUuidNumber" id="shangpinUuidNumber" lay-verify="required" placeholder="商品编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="mingxingchanpinTypes" id="mingxingchanpinTypes">
                ...
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shangpinClicknum" id="shangpinClicknum"  lay-verify="required|integer"   placeholder="商品热度" autocomplete="off" class="layui-input">
							</div>
						</div>
