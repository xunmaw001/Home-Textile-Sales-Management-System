            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">商家名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shangjiaName" id="shangjiaName"  placeholder="商家名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">联系方式:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shangjiaPhone" id="shangjiaPhone"  lay-verify="phone|required"   placeholder="联系方式" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 邮箱 -->
                <div class="layui-form-item" pane>
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">邮箱:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shangjiaEmail" id="shangjiaEmail"  lay-verify="email|required"   placeholder="邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">商家信用类型:</span>
                        <div class="layui-input-inline">
                            <select name="shangjiaXingjiTypes" id="shangjiaXingjiTypes" lay-filter="shangjiaXingjiTypes" style="width: 600px;">
