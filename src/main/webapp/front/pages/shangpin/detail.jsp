        ...
        <div class="data-detail">
            ...
            <div class="layui-row">
                ...
                <div class="layui-col-md7" style="padding-left: 20px;">
                        ...
                        <div v-if="detail.shangpinUuidNumber" class="detail-item">
                            <span>商品编号：</span>
                            <span class="desc">
                        ...
                        <div v-if="detail.mingxingchanpinTypes" class="detail-item">
                            <span>是否明星产品：</span>
                            <span class="desc">
                                {{detail.mingxingchanpinValue}}
                            </span>
                        </div>
                            ...
                            <div class="layui-tab-item">
                                <div class="message-container">
                                    <form class="layui-form message-form" style="padding-right: 20px;border-bottom: 0;">
                                        <div class="layui-form-item layui-form-text">
                                            ...
                                            <div class="layui-input-block">
                                                <textarea name="shangpinLiuyanText" id="shangpinLiuyanText" required lay-verify="required" placeholder="留言内容" class="layui-textarea"></textarea>
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            <div class="layui-input-block">
                                                <button class="layui-btn btn-submit" lay-submit lay-filter="shangpinLiuyanText">
                                                    立即提交
                                                </button>
                                    ...
                                    <div class="message-list">
                                        <div class="message-item" v-for="(item,index) in shangpinLiuyanDataList" v-bind:key="index">
                                            ...
                                            <div class="content">
                                                    <span style="color: rgb(175, 135, 77)">
                                                        留言:<div v-html="item.shangpinLiuyanText"></div>
                                                    </span>
                                            </div>
                                            <div class="content">
                                                    <span style="color: rgb(175, 135, 77)">
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage', 'rate'], function () {
        ...
        http.request(`shangpin/list`, 'get', {
            ...
            shangpinDelete: 1,
                ...
                mingxingchanpinTypes: vue.detail.mingxingchanpinTypes,
        ...
        form.on('submit(shangpinLiuyanText)', function (data) {
            ...
            if(data.shangpinLiuyanText == null || data.shangpinLiuyanText == ''){
                layer.msg("留言不能为空", {
                    time: 2000,
                    icon: 2
                });
