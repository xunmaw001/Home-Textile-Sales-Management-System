    ...
    */
    ...
    public R save(@RequestBody ShangpinEntity shangpin, HttpServletRequest request){
        ...
        if(false)
            ...
            shangpin.setMingxingchanpinTypes(1);
        ...
        Wrapper<ShangpinEntity> queryWrapper = new EntityWrapper<ShangpinEntity>()
            ...
            .eq("mingxingchanpin_types", shangpin.getMingxingchanpinTypes())
...
//                            shangpinEntity.setMingxingchanpinTypes(Integer.valueOf(data.get(0)));   //是否明星产品 要改的
...
//                            shangpinEntity.setShangpinClicknum(Integer.valueOf(data.get(0)));   //商品热度 要改的
