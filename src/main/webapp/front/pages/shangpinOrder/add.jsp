    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="shangpin.shangpinUuidNumber" type="text"  readonly="readonly" name="shangpinUuidNumber" id="shangpinUuidNumber" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="shangpin.mingxingchanpinValue" type="text" readonly="readonly" placeholder="是否明星产品" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="shangpin.shangpinClicknum" type="text" readonly="readonly" name="shangpinClicknum" id="shangpinClicknum"   placeholder="商品热度" autocomplete="off" class="layui-input">
                </div>
            </div>
...
<!-- 唯一uuid -->
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="detail.shangpinOrderUuidNumber" type="text" name="shangpinOrderUuidNumber" id="shangpinOrderUuidNumber"  lay-verify="required"   placeholder="订单号" autocomplete="off" class="layui-input" readonly="readonly">
                </div>
            </div>
            <!-- 级联表的表id -->
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input <%--v-model="detail.shangpinOrderCourierName"--%> type="text" name="shangpinOrderCourierName" id="shangpinOrderCourierName" placeholder="快递公司" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input <%--v-model="detail.shangpinOrderCourierNumber"--%> type="text" name="shangpinOrderCourierNumber" id="shangpinOrderCourierNumber" placeholder="订单快递单号" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            http.requestJson('shangpinOrder/add', 'post', data, function (res) {
                if(res.code == 0){
                    layer.msg('提交成功', {
                        ...
                        vue.jump("../shangpinOrder/list.jsp");
                        // back();
                    });
