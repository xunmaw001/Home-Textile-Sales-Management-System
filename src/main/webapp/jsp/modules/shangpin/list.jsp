...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        是否明星产品
                                        <div class="layui-input-inline">
                                            <select name="mingxingchanpinTypesSelectSearch"  style="width: 150px;" id="mingxingchanpinTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="shangjiaNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="商家名称" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //是否明星产品
            var mingxingchanpinTypesCell = document.createElement('td');
            mingxingchanpinTypesCell.innerHTML = item.mingxingchanpinValue;
            row.appendChild(mingxingchanpinTypesCell);
