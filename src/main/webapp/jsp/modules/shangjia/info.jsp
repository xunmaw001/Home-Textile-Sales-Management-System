            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">商家登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shangjiaName" name="shangjiaName" class="form-control"
                                               v-model="ruleForm.shangjiaName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shangjiaPhone" name="shangjiaPhone" class="form-control"
                                               v-model="ruleForm.shangjiaPhone" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shangjiaEmail" name="shangjiaEmail" class="form-control"
                                               v-model="ruleForm.shangjiaEmail" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>营业执照展示</label>
                                    <img id="shangjiaPhotoImg" width="100" height="100">
                                </div>

                                <div class="form-group col-md-6">
                                    <label>商家信用类型</label>
                                    <input style="width: 450px" id="shangjiaXingjiValue" name="shangjiaXingjiValue" class="form-control"
                                           v-model="ruleForm.shangjiaXingjiValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.shangjiaContent != null && ruleForm.shangjiaContent != 'null' && ruleForm.shangjiaContent != '') {
            var shangjiaContentUeditor = UE.getEditor('shangjiaContentEditor');
                shangjiaContentUeditor.ready(function () {
                    ...
                    shangjiaContentUeditor.setDisabled('fullscreen');
            });
        }
    }
