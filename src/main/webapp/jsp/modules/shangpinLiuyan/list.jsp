...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">商品留言管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">商品留言管理</li>
                            <li class="breadcrumb-item active">商品留言列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">商品留言列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("shangpinLiuyan/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                shangpinLiuyanDelete: 1,
                //本表的
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //留言内容
            var shangpinLiuyanTextCell = document.createElement('td');
            shangpinLiuyanTextCell.innerHTML = item.shangpinLiuyanText;
            row.appendChild(shangpinLiuyanTextCell);
            ...
            if(
                window.sessionStorage.getItem('role') == "管理员"
                 || (window.sessionStorage.getItem('role') == "商家" && window.sessionStorage.getItem('userId') == item.shangpinShangjiaId)
            ){
                //修改按钮
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("shangpinLiuyan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addshangpinLiuyan", "addshangpinLiuyan");
            window.location.href = "add-or-update.jsp"
        }
