...
<!-- 唯一uuid -->
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="detail.yonghuUuidNumber" type="text" name="yonghuUuidNumber" id="yonghuUuidNumber"  lay-verify="required"   placeholder="用户唯一编号" autocomplete="off" class="layui-input" readonly="readonly">
                </div>
            </div>
            <div class="layui-form-item" pane>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate', 'tinymce'], function () {
        ...
        vue.detail.yonghuUuidNumber = new Date().getTime();
