...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">商家列表</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //商家信用类型
            var shangjiaXingjiTypesCell = document.createElement('td');
            shangjiaXingjiTypesCell.innerHTML = item.shangjiaXingjiValue;
            row.appendChild(shangjiaXingjiTypesCell);
