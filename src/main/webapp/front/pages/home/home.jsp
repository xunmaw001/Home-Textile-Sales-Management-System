    ...
    <div class="ng-container ng-fault">
            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div style="margin-top: 2em;">
                        <div v-for="(item,index) in shangpinList" v-bind:key="index"  class="col-md-3 list-grid">
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div style="margin-top: 2em;">
                        <div v-for="(item,index) in shangpinList1" v-bind:key="index"  class="col-md-3 list-grid">
                            <div @click="jumpCheck('../shangpin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="list-img">
                                <img :src="item.shangpinPhoto?item.shangpinPhoto.split(',')[0]:''" class="img-responsive" style="height: 350px;width:100%;" />
                                <div class="textbox"></div>
                                <h4 >名称:{{item.shangpinName}}</h4>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div style="margin-top: 2em;">
                        <div v-for="(item,index) in gonggaoList" v-bind:key="index"  class="col-md-3 list-grid">
                            <div @click="jumpCheck('../gonggao/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="list-img">
                                <img :src="item.gonggaoPhoto?item.gonggaoPhoto.split(',')[0]:''" class="img-responsive" style="height: 350px;width:100%;" />
                                <div class="textbox"></div>
                                <h4 >名称:{{item.gonggaoName}}</h4>
                                <p v-if="item.gonggaoNewMoney != null" style="color: red;" >￥{{item.gonggaoNewMoney}}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div style="margin-top: 2em;">
                        <div v-for="(item,index) in shangjiaList" v-bind:key="index"  class="col-md-3 list-grid">
                            <div @click="jumpCheck('../shangjia/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="list-img">
                                <img :src="item.shangjiaPhoto?item.shangjiaPhoto.split(',')[0]:''" class="img-responsive" style="height: 350px;width:100%;" />
                                <div class="textbox"></div>
                                <h4 >名称:{{item.shangjiaName}}</h4>
                                <p v-if="item.shangjiaNewMoney != null" style="color: red;" >￥{{item.shangjiaNewMoney}}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`shangpin/list`, 'get', {
            ...
            vue.shangpinList1 = res.data.list;
        });
