                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="shangjiaName" id="shangjiaName" placeholder="商家名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-md-3" v-for="(item,index) in dataList" >
                                <div class="galry-grid grid-top-rgt">
                                    <a href="javascript:return false;"  @click="jumpCheck('../shangjia/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img class="img-responsive zoom-img" :src="item.shangjiaPhoto?item.shangjiaPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="w3agile-text">
                                            <h5>
                                                <span>{{item.shangjiaName}}</span>
                                                <br/>
                                                <span v-if="item.shangjiaNewMoney">
                                                    {{item.shangjiaNewMoney}} RMB
                                                </span>
                                                <span v-else>
                                                    {{item.shangjiaValue}}
                                                </span>
...
<script>
    ...
    // 当前表的字典表
        ...
        function shangjiaXingjiTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shangjia_xingji_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            if (jquery('#shangjiaName').val() != null && jquery('#shangjiaName').val() != "" && jquery('#shangjiaName').val() != "null" ) {
                param['shangjiaName'] = jquery('#shangjiaName').val();
            }
