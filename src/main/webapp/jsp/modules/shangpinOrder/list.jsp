        ...
        <div class="modal-dialog" style="z-index: 3000">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    评价内容:<textarea id="shangpinCommentbackContent" style="width: 400px;height: 300px"></textarea>
                </div>
                <%-- 模态框按钮 --%>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" onclick="submitShangpinCommentback()" class="btn btn-info">评价</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" style="z-index: 3000">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    快递公司:
                    <input type="text" id="shangpinOrderCourierName" style="width: 300px;" class="form-control form-control-sm"
                           placeholder="快递公司" aria-controls="tableId">
                    订单快递单号:
                    <input type="text" id="shangpinOrderCourierNumber" style="width: 300px;" class="form-control form-control-sm"
...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        订单类型
                                        <div class="layui-input-inline">
                                            <select name="shangpinOrderTypesSelectSearch"  style="width: 150px;" id="shangpinOrderTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        var mingxingchanpinTypesOptions = [];
        ...
        <!-- 级联表的级联字典表 -->
            ...
            var mingxingchanpinTypesSelectSearchInput = document.getElementById("mingxingchanpinTypesSelectSearch");
            if(mingxingchanpinTypesSelectSearchInput != null){
                var mingxingchanpinTypesIndex = mingxingchanpinTypesSelectSearchInput.selectedIndex;
                if( mingxingchanpinTypesIndex  != 0){
                    searchForm.mingxingchanpinTypes = document.getElementById("mingxingchanpinTypesSelectSearch").options[mingxingchanpinTypesIndex].value;
                }
            }
            ...
            if( shangpinOrderUuidNumberSearchInput != null){
                ...
                //订单类型
            var shangpinOrderTypesSelectSearchInput = document.getElementById("shangpinOrderTypesSelectSearch");
            if(shangpinOrderTypesSelectSearchInput != null){
                var shangpinOrderTypesIndex = shangpinOrderTypesSelectSearchInput.selectedIndex;
                if( shangpinOrderTypesIndex  != 0){
                    searchForm.shangpinOrderTypes= document.getElementById("shangpinOrderTypesSelectSearch").options[shangpinOrderTypesIndex].value;
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("shangpinOrder/page", "GET", {
                ...
                shangpinOrderTypes: searchForm.shangpinOrderTypes,
            //级联表的
                ...
                mingxingchanpinTypes: searchForm.mingxingchanpinTypes,
        ...
        function setDataRow(item, number) {
            ...
            //快递公司
            var shangpinOrderCourierNameCell = document.createElement('td');
            shangpinOrderCourierNameCell.innerHTML = item.shangpinOrderCourierName;
            row.appendChild(shangpinOrderCourierNameCell);


            //订单快递单号
            var shangpinOrderCourierNumberCell = document.createElement('td');
            shangpinOrderCourierNumberCell.innerHTML = item.shangpinOrderCourierNumber;
            row.appendChild(shangpinOrderCourierNumberCell);
            ...
            if(item.shangpinOrderTypes == 1 && window.sessionStorage.getItem('role') == "用户"){
                //退款
            ...
            if(item.shangpinOrderTypes == 1 && window.sessionStorage.getItem('role') == "商家"){
                //发货
                var detailListBtn = document.createElement('button');
    ...
    //填充级联表搜索下拉框
        ...
        function mingxingchanpinTypesSelectSearch() {
            var mingxingchanpinTypesSelectSearch = document.getElementById('mingxingchanpinTypesSelectSearch');
            if(mingxingchanpinTypesSelectSearch != null) {
                mingxingchanpinTypesSelectSearch.add(new Option('-请选择-',''));
                if (mingxingchanpinTypesOptions != null && mingxingchanpinTypesOptions.length > 0){
                    for (var i = 0; i < mingxingchanpinTypesOptions.length; i++) {
                            mingxingchanpinTypesSelectSearch.add(new Option(mingxingchanpinTypesOptions[i].indexName, mingxingchanpinTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //填充本表搜索下拉框
        ...
        function shangpinOrderTypesSelectSearch() {
            var shangpinOrderTypesSelectSearch = document.getElementById('shangpinOrderTypesSelectSearch');
            if(shangpinOrderTypesSelectSearch != null) {
                shangpinOrderTypesSelectSearch.add(new Option('-请选择-',''));
                if (shangpinOrderTypesOptions != null && shangpinOrderTypesOptions.length > 0){
                    for (var i = 0; i < shangpinOrderTypesOptions.length; i++) {
                            shangpinOrderTypesSelectSearch.add(new Option(shangpinOrderTypesOptions[i].indexName,shangpinOrderTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询级联表搜索条件所有列表
            ...
            function mingxingchanpinTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=mingxingchanpin_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        mingxingchanpinTypesOptions = res.data.list;
                    }
                });
            }
    ...
    //查询当前表搜索条件所有列表
        ...
        function openDeliver(id){
            //清空快递单号
            $("#shangpinOrderCourierNumber").val("");
            //快递公司
            $("#shangpinOrderCourierName").val("");
            //赋值
            $("#deliverId").val(id);
            //打开模态框
        ...
        // 发货
        function deliver() {
            var shangpinOrderCourierName = $("#shangpinOrderCourierName").val();
            if(shangpinOrderCourierName == null || shangpinOrderCourierName == ""){
                alert('快递公司不能为空');
                return false;
            }
            var shangpinOrderCourierNumber = $("#shangpinOrderCourierNumber").val()
            if( shangpinOrderCourierNumber == null || shangpinOrderCourierNumber == ""){
                alert('订单快递单号不能为空');
                return false;
            }

            http("shangpinOrder/deliver?id="+$("#deliverId").val()+"&shangpinOrderCourierName="+shangpinOrderCourierName+"&shangpinOrderCourierNumber="+shangpinOrderCourierNumber, "GET",{}, (res) => {
                if(res.code == 0){
                    alert('成功发货');
        ...
        function commentback(id) {
            ...
            $("#shangpinCommentbackContent").val("")//评价内容
        ...
        //级联表的下拉框赋值
            ...
            mingxingchanpinTypesSelectSearch();
