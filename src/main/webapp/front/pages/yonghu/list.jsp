            ...
            <div class="ng-inmod-ini">
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">用户唯一编号</label>
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuUuidNumber" id="yonghuUuidNumber" placeholder="用户唯一编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#yonghuUuidNumber').val() != null && jquery('#yonghuUuidNumber').val() != "" && jquery('#yonghuUuidNumber').val() != "null" ) {
                param['yonghuUuidNumber'] = jquery('#yonghuUuidNumber').val();
            }
