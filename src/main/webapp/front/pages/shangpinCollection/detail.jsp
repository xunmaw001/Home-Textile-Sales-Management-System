        ...
        <div class="data-detail">
            ...
            <div class="layui-row">
                ...
                <div class="layui-col-md7" style="padding-left: 20px;">
                        <div v-if="detail.shangpinCollectionTypes" class="detail-item">
                            <span>类型：</span>
                            <span class="desc">
                    ...
                    <div class="detail-item">
                        ...
                        <!--<button onclick="addShangpinCollectionqqqqqqqq()" type="button" class="layui-btn layui-btn-warm">
                                添加到购物车
                            </button>-->
                            <!--<div style="padding: 20px;border: 0px solid #f2f2f2;margin-top: 20px;display: flex">
                                <div class="num-picker">
                                    <button @click="shangpinCollectionYuyue()" style="height:auto;" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,.3)","margin":"0 5px","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(23, 124, 176, 1)","color":"rgba(255, 255, 255, 1)","borderRadius":"6px","borderWidth":"0","width":"auto","lineHeight":"40px","fontSize":"16px","borderStyle":"solid"}' type="button" class="layui-btn btn-submit">
                                        立即预约
                                    </button>
                                </div>
                            </div>-->
...
<script>
    ...
    var vue = new Vue({
        ...
        methods: {
            ...
            //预约
            ,shangpinCollectionYuyue(){
                let _this = this;
                // localStorage.setItem('shangpinCollectionId', _this.detail.id);
                // _this.jump("../shangpinCollectionOrder/add.jsp");

                let data={
                    shangpinCollectionId:_this.detail.id,
                    yonghuId:localStorage.getItem("userid"),
                    shangpinCollectionOrderYesnoTypes:1,
                }
                // 提交数据
                layui.http.requestJson('shangpinCollectionOrder/add', 'post', data, function (res) {
                    if(res.code == 0) {
                        layui.layer.msg('预约成功', {
                            time: 2000,
                            icon: 6
                        }, function () {
                            _this.jump("../shangpinCollectionOrder/list.jsp");
                        });
                    }else{
