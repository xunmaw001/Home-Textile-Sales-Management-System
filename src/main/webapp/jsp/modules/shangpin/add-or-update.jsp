                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="shangjiaId" name="shangjiaId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6 shangpinUuidNumberDiv">
                                        <label>商品编号</label>
                                        <input style="width: 450px" id="shangpinUuidNumber" name="shangpinUuidNumber" class="form-control"
                                               placeholder="商品编号">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mingxingchanpinTypesDiv">
                                        <label>是否明星产品</label>
                                        <select style="width: 450px" id="mingxingchanpinTypesSelect" name="mingxingchanpinTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationMingxingchanpintypesSelect(){
            var mingxingchanpinTypesSelect = document.getElementById('mingxingchanpinTypesSelect');
            if(mingxingchanpinTypesSelect != null && mingxingchanpinTypesOptions != null  && mingxingchanpinTypesOptions.length > 0 ){
                for (var i = 0; i < mingxingchanpinTypesOptions.length; i++) {
                    mingxingchanpinTypesSelect.add(new Option(mingxingchanpinTypesOptions[i].indexName,mingxingchanpinTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(mingxingchanpinTypesSelect != null && mingxingchanpinTypesOptions != null  && mingxingchanpinTypesOptions.length > 0 ) {
            for (var i = 0; i < mingxingchanpinTypesOptions.length; i++) {
                if (mingxingchanpinTypesOptions[i].codeIndex == ruleForm.mingxingchanpinTypes) {//下拉框value对比,如果一致就赋值汉字
                        mingxingchanpinTypesSelect.options[i].selected = true;
                }
            }
        }
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                shangpinUuidNumber: "required",
                shangpinPhoto: "required",
                shangpinTypes: "required",
                mingxingchanpinTypes: "required",
    ...
    function getDetails() {
        ...
        if (addshangpin != null && addshangpin != "" && addshangpin != "null") {
            //注册表单验证
            $(validform());
            $("#shangpinUuidNumber").val(new Date().getTime()+Math.ceil(Math.random()*10));//设置唯一号
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#shangpinUuidNumber").val(ruleForm.shangpinUuidNumber);
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationMingxingchanpintypesSelect();
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".mingxingchanpinTypesDiv").remove();//删除当前用户的信息
        }
        else{
            // alert("未知情况.......");
