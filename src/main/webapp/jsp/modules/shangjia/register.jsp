...
<body style="background-image:url('/jiafangyongpinxiaoshou/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>商家名称</label>
                                    <input id="shangjiaName" name="shangjiaName" class="form-control"
                                           placeholder="商家名称">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>联系方式</label>
                                    <input id="shangjiaPhone" name="shangjiaPhone" class="form-control"
                                           onchange="shangjiaPhoneChickValue(this)"  placeholder="联系方式">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>邮箱</label>
                                    <input id="shangjiaEmail" name="shangjiaEmail" class="form-control"
                                           placeholder="邮箱">
                                </div>
                                   <div class="form-group col-md-12">
                                       <label>商家信用类型</label>
                                       <select id="shangjiaXingjiTypesSelect" name="shangjiaXingjiTypes" class="form-control">
                                       </select>
                                   </div>
                                   <div class="form-group  col-md-12">
                                       <label>商家简介</label>
